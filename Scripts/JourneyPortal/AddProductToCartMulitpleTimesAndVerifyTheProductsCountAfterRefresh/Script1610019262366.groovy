...
int orderCount = CustomKeywords.'pages.JourneyPortal.clickAddToCartButton'()

CustomKeywords.'login.LoginForJourneyApplication.reloadThePage'()

int productCount = CustomKeywords.'pages.JourneyPortal.getProductsCount'()

CustomKeywords.'pages.JourneyPortal.verifyWhetherOrderedAndAvailableProductsCountAreSame'(orderCount, productCount)