...
CustomKeywords.'pages.JourneyPortal.verifyCloseButton'()

CustomKeywords.'pages.JourneyPortal.clickCloseButtonOnJourneyPortalProductPopup'()

CustomKeywords.'pages.JourneyPortal.productPageCheck'()
